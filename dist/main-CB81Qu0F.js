...
function requireMain () {
	...
	const components = [
	  ...
	  },
	  {
	    ...
	    importFn: () => import('./centers-coe-C00ycg2N.js'),
	  },
	  {
	    selector: "[data-component='centers-all']",
	    importFn: () => import('./centers-all-6ag0tVGN.js'),
	  },
	  {
	  ...
	  },
	  {
	    ...
	    importFn: () => import('./join-us-ZoBKnkq9.js'),
	  },
	  {
	    selector: "[data-component='helpline-form']",
	    importFn: () => import('./helpline-CwByPSA0.js'),
	  },
	  {
	    selector: "[data-component='phone-buddy-form']",
	    importFn: () => import('./phone-buddy-BAVr31NU.js'),
	  },
	  {
	    selector: "[data-component='volunteer-phone-buddy-form']",
	    importFn: () => import('./volunteer-phone-buddy-CoOffhA8.js'),
	  },
	  {
	    selector: "[data-component='including-form']",
	    importFn: () => import('./including-D85u_de7.js'),
	  },
	  {
	    selector: "[data-component='mind-over-matter-form']",
	    importFn: () => import('./mind-over-matter-wtrPLPjx.js'),
	  },
	  {
	    selector: "[data-component='share-your-story-form']",
	    importFn: () => import('./share-your-story-RF5-jVwk.js'),
	  },
	  {
	    selector: "[data-component='support-group-interest']",
	    importFn: () => import('./support-group-interest-4tG9Zkih.js'),
	  },
	  {
	    selector: "[data-component='graphics-bars']",
	    importFn: () => import('./graphics-bars-dCYEqQ57.js'),
	  },
	  {
...
//# sourceMappingURL=main-CB81Qu0F.js.map
