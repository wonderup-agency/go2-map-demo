...
function requireMain () {
	...
	const components = [
	  ...
	  },
	  {
	    ...
	    importFn: () => import('./join-us-Y1k3iCh5.js'),
	  },
	  {
	    selector: "[data-component='helpline-form']",
	    importFn: () => import('./helpline-DjBlkY3t.js'),
	  },
	  {
	    selector: "[data-component='phone-buddy-form']",
	    importFn: () => import('./phone-buddy-BJyo70Ti.js'),
	  },
	  {
	    selector: "[data-component='volunteer-phone-buddy-form']",
	    importFn: () => import('./volunteer-phone-buddy-BPb5ssKj.js'),
	  },
	  {
	    selector: "[data-component='including-form']",
	    importFn: () => import('./including-C4SFamKq.js'),
	  },
	  {
	    selector: "[data-component='mind-over-matter-form']",
	    importFn: () => import('./mind-over-matter-BShQYLCE.js'),
	  },
	  {
	    selector: "[data-component='share-your-story-form']",
	    importFn: () => import('./share-your-story-B9VECeiF.js'),
	  },
	  {
	    selector: "[data-component='support-group-interest']",
	    importFn: () => import('./support-group-interest-DM7dySGs.js'),
	  },
	  {
	    selector: "[data-component='email-subscribe']",
	    importFn: () => import('./email-subscribe-9ciCWRcc.js'),
	  },
	  {
	  ...
	  },
	  {
	    ...
	    importFn: () => import('./breadcrumbs-Dcqv2_R7.js'),
	  },
	  {
	  ...
	  },
	  {
	    ...
	    importFn: () => import('./testimonial-slider-DQMtnlBC.js'),
	  },
	  {
...
//# sourceMappingURL=main-CLc-8hT6.js.map
