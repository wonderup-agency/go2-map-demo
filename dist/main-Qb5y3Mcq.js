...
function requireMain () {
	...
	const components = [
	  ...
	  },
	  {
	    ...
	    importFn: () => import('./events-cVTqxieq.js'),
	  },
	  {
	  ...
	  },
	  {
	    ...
	    importFn: () => import('./join-us-C7NGvQH_.js'),
	  },
	  {
	    selector: "[data-component='helpline-form']",
	    importFn: () => import('./helpline-C7rbw_rT.js'),
	  },
	  {
	    selector: "[data-component='phone-buddy-form']",
	    importFn: () => import('./phone-buddy-Aknx98ru.js'),
	  },
	  {
	    selector: "[data-component='volunteer-phone-buddy-form']",
	    importFn: () => import('./volunteer-phone-buddy-DCh7l4pf.js'),
	  },
	  {
	    selector: "[data-component='including-form']",
	    importFn: () => import('./including-CdlpdPNJ.js'),
	  },
	  {
	    selector: "[data-component='mind-over-matter-form']",
	    importFn: () => import('./mind-over-matter-D3wxqpoB.js'),
	  },
	  {
	    selector: "[data-component='share-your-story-form']",
	    importFn: () => import('./share-your-story-B6CqtHiC.js'),
	  },
	  {
	    selector: "[data-component='support-group-interest']",
	    importFn: () => import('./support-group-interest-BCYQPHn4.js'),
	  },
	  {
	    selector: "[data-component='email-subscribe']",
	    importFn: () => import('./email-subscribe-Wc_Zr-59.js'),
	  },
	  {
...
//# sourceMappingURL=main-Qb5y3Mcq.js.map
