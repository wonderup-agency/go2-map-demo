...
function requireMain () {
	...
	const components = [
	  ...
	  },
	  {
	    ...
	    importFn: () => import('./events-CSH9ofLF.js'),
	  },
	  {
	  ...
	  },
	  {
	    ...
	    importFn: () => import('./join-us-b0rqnjpd.js'),
	  },
	  {
	    selector: "[data-component='helpline-form']",
	    importFn: () => import('./helpline-W0PTOnRl.js'),
	  },
	  {
	    selector: "[data-component='phone-buddy-form']",
	    importFn: () => import('./phone-buddy-DV8_dPGK.js'),
	  },
	  {
	    selector: "[data-component='volunteer-phone-buddy-form']",
	    importFn: () => import('./volunteer-phone-buddy-DjMMvB0G.js'),
	  },
	  {
	    selector: "[data-component='including-form']",
	    importFn: () => import('./including-D3x7H_iz.js'),
	  },
	  {
	    selector: "[data-component='mind-over-matter-form']",
	    importFn: () => import('./mind-over-matter-MgLiarOR.js'),
	  },
	  {
	    selector: "[data-component='share-your-story-form']",
	    importFn: () => import('./share-your-story-DPtfSjWm.js'),
	  },
	  {
	    selector: "[data-component='support-group-interest']",
	    importFn: () => import('./support-group-interest-KQgnwyvd.js'),
	  },
	  {
	    selector: "[data-component='email-subscribe']",
	    importFn: () => import('./email-subscribe-D0-ZB9Nj.js'),
	  },
	  {
...
//# sourceMappingURL=main-BHpRZqdi.js.map
