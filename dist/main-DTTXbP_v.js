...
function requireMain () {
	...
	const components = [
	  ...
	  },
	  {
	    ...
	    importFn: () => import('./join-us-D3xg84hw.js'),
	  },
	  {
	    selector: "[data-component='helpline-form']",
	    importFn: () => import('./helpline-BqhL2BIl.js'),
	  },
	  {
	    selector: "[data-component='phone-buddy-form']",
	    importFn: () => import('./phone-buddy-Dl6TFbdf.js'),
	  },
	  {
	    selector: "[data-component='volunteer-phone-buddy-form']",
	    importFn: () => import('./volunteer-phone-buddy-Bsfyk8uE.js'),
	  },
	  {
	    selector: "[data-component='including-form']",
	    importFn: () => import('./including-CtE2OsP2.js'),
	  },
	  {
	    selector: "[data-component='mind-over-matter-form']",
	    importFn: () => import('./mind-over-matter-ChRk8fQj.js'),
	  },
	  {
	    selector: "[data-component='share-your-story-form']",
	    importFn: () => import('./share-your-story-DrRTc98U.js'),
	  },
	  {
	    selector: "[data-component='support-group-interest']",
	    importFn: () => import('./support-group-interest-BGsJpDVl.js'),
	  },
	  {
...
//# sourceMappingURL=main-DTTXbP_v.js.map
