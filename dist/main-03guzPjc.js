...
function requireMain () {
	...
	const components = [
	  ...
	  },
	  {
	    ...
	    importFn: () => import('./centers-coe-DKOuLKh-.js'),
	  },
	  {
	    selector: "[data-component='centers-all']",
	    importFn: () => import('./centers-all-DGEFwIRw.js'),
	  },
	  {
	  ...
	  },
	  {
	    ...
	    importFn: () => import('./join-us-eM-Wkcji.js'),
	  },
	  {
	    selector: "[data-component='helpline-form']",
	    importFn: () => import('./helpline-D2C6nSQK.js'),
	  },
	  {
	    selector: "[data-component='phone-buddy-form']",
	    importFn: () => import('./phone-buddy-D0LUfTxG.js'),
	  },
	  {
	    selector: "[data-component='volunteer-phone-buddy-form']",
	    importFn: () => import('./volunteer-phone-buddy-B4lCYOtS.js'),
	  },
	  {
	    selector: "[data-component='including-form']",
	    importFn: () => import('./including-Dhx6QDRA.js'),
	  },
	  {
	    selector: "[data-component='mind-over-matter-form']",
	    importFn: () => import('./mind-over-matter-DL1LrN4d.js'),
	  },
	  {
	    selector: "[data-component='share-your-story-form']",
	    importFn: () => import('./share-your-story-Dcp-OW1i.js'),
	  },
	  {
	    selector: "[data-component='support-group-interest']",
	    importFn: () => import('./support-group-interest-Dh-D6Ndb.js'),
	  },
	  {
	  ...
	  },
	  {
	    ...
	    importFn: () => import('./palliative-care-RZJzIELB.js'),
	  },
	  {
	    selector: "[data-component='social-share']",
	    importFn: () => import('./social-share-CmU6gx2B.js'),
	  },
...
//# sourceMappingURL=main-03guzPjc.js.map
