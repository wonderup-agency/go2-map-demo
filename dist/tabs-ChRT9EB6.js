  ...
  for (const root of roots) {
    ...
    wrappers.forEach((wrapper) => {
      ...
      const recomputeHeightsAll = () => {
        ...
        applyMinHeight();
        if (isDesktop()) {
          gsapWithCSS.set(wrapper, { height: Math.max(inner.offsetHeight, maxVisualHeight) });
        }
      };
      // -------------------------
      ...
      const recomputeHeight = () => {
        ...
        if (isDesktop()) gsapWithCSS.set(wrapper, { height: Math.max(inner.offsetHeight, maxVisualHeight) });
      };
      ...
      function applyMode() {
        if (isDesktop()) {
          ...
          setVisualHitTestInline(wrapper); // prevent visuals from stealing taps
      ...
      function openDetailsForMeasure(scope) {
        ...
        getDetailsEls(scope).forEach((el) => {
          ...
          gsapWithCSS.set(el, { height: 'auto' });
        });
      ...
      function hideAllVisualsExcept(keep) {
        visualItems.forEach((el) => {
          if (el !== keep) {
            ...
            gsapWithCSS.set(el, { autoAlpha: 0, xPercent: 3 });
          }
        });
      }
...
//# sourceMappingURL=tabs-ChRT9EB6.js.map
