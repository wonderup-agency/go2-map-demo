...
function requireMain () {
	...
	const components = [
	  ...
	  },
	  {
	    ...
	    importFn: () => import('./join-us-D6YQeD-5.js'),
	  },
	  {
	    selector: "[data-component='helpline-form']",
	    importFn: () => import('./helpline-DHv9AjaR.js'),
	  },
	  {
	    selector: "[data-component='phone-buddy-form']",
	    importFn: () => import('./phone-buddy-DEx3w8j3.js'),
	  },
	  {
	    selector: "[data-component='volunteer-phone-buddy-form']",
	    importFn: () => import('./volunteer-phone-buddy-DUVaLNJx.js'),
	  },
	  {
	    selector: "[data-component='including-form']",
	    importFn: () => import('./including-DBOCVIa2.js'),
	  },
	  {
	    selector: "[data-component='mind-over-matter-form']",
	    importFn: () => import('./mind-over-matter-B4sFBYIU.js'),
	  },
	  {
	    selector: "[data-component='share-your-story-form']",
	    importFn: () => import('./share-your-story-CPJN1U6k.js'),
	  },
	  {
	    selector: "[data-component='support-group-interest']",
	    importFn: () => import('./support-group-interest-BoVwmn2T.js'),
	  },
	  {
	  ...
	  },
	  {
	    ...
	    importFn: () => import('./testimonial-slider-4H7caPrP.js'),
	  },
	  {
...
//# sourceMappingURL=main-DqPHEQxV.js.map
