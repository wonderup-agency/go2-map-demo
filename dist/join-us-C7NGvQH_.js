import { h as hideFail, s as serializeInputs, v as validator, c as clearStepsErrors, a as appendStepsErrors, b as setButtonLoading, d as hideForm, e as showSuccess, f as showFail, r as resetButton } from './index-knRv7KsO.js';
    ...
    formInstance.addEventListener('click', async (e) => {
      ...
      if (submitBtn || (buttonText && submitBtn)) {
        ...
        fetch(webhookAddress, {
          ...
          body: JSON.stringify({ ...submitInputsData, tag: 'All Database (MM/YC Mirror)' }),
        })
          .then((response) => {
...
//# sourceMappingURL=join-us-C7NGvQH_.js.map
