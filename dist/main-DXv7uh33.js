	...
	const components = [
	  {
	    ...
	    importFn: () => import('./tooltip-6GI5EuS1.js'),
	  },
	  {
	    selector: "[data-component='events']",
	    importFn: () => import('./events-C4EHPYHp.js'),
	  },
	  {
	    selector: "[data-component='centers']",
	    importFn: () => import('./centers-BdMwRcjb.js'),
	  },
	  {
	  ...
	  },
	  {
	    ...
	    importFn: () => import('./join-us--y_OT5x4.js'),
	  },
	  {
	    selector: "[data-component='helpline-form']",
	    importFn: () => import('./helpline-CYiy7-K6.js'),
	  },
	  {
	    selector: "[data-component='phone-buddy-form']",
	    importFn: () => import('./phone-buddy-DQ_8WskH.js'),
	  },
	  {
	    selector: "[data-component='volunteer-phone-buddy-form']",
	    importFn: () => import('./volunteer-phone-buddy-CTz4Gbqn.js'),
	  },
	  {
	    selector: "[data-component='including-form']",
	    importFn: () => import('./including-e1QWyoDv.js'),
	  },
	  {
	    selector: "[data-component='mind-over-matter-form']",
	    importFn: () => import('./mind-over-matter-CTR4jSww.js'),
	  },
	  {
	    selector: "[data-component='share-your-story-form']",
	    importFn: () => import('./share-your-story-DLTLdV5_.js'),
	  },
	  {
	    selector: "[data-component='support-group-interest']",
	    importFn: () => import('./support-group-interest-C_FFfsj9.js'),
	  },
	  {
	  ...
	  },
	  {
	    ...
	    importFn: () => import('./tabs-BAi6vg0J.js'),
	  },
	  {
...
//# sourceMappingURL=main-DXv7uh33.js.map
