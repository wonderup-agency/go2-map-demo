...
function requireMain () {
	...
	const components = [
	  ...
	  },
	  {
	    ...
	    importFn: () => import('./join-us-BBkme9HL.js'),
	  },
	  {
	    selector: "[data-component='helpline-form']",
	    importFn: () => import('./helpline-KGZiT5_t.js'),
	  },
	  {
	    selector: "[data-component='phone-buddy-form']",
	    importFn: () => import('./phone-buddy-Dwuj8qJl.js'),
	  },
	  {
	    selector: "[data-component='volunteer-phone-buddy-form']",
	    importFn: () => import('./volunteer-phone-buddy-Da6U-HiK.js'),
	  },
	  {
	    selector: "[data-component='including-form']",
	    importFn: () => import('./including-DjB2AW_s.js'),
	  },
	  {
	    selector: "[data-component='mind-over-matter-form']",
	    importFn: () => import('./mind-over-matter-DYzq02ZZ.js'),
	  },
	  {
	    selector: "[data-component='share-your-story-form']",
	    importFn: () => import('./share-your-story-BuZbIwPt.js'),
	  },
	  {
	    selector: "[data-component='support-group-interest']",
	    importFn: () => import('./support-group-interest-BVfQofYI.js'),
	  },
	  {
...
//# sourceMappingURL=main-C_gHVAux.js.map
