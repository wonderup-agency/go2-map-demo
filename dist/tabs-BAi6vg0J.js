    ...
    wrappers.forEach((wrapper) => {
      ...
      const stopProgressBar = () => {
        ...
        contentItems.forEach((item) => {
          ...
          if (bar) gsapWithCSS.set(bar, { scaleX: 0, transformOrigin: 'left center' });
        });
      };
      ...
      function switchTab(index) {
        ...
        if (detailsIn) gsapWithCSS.set(detailsIn, { height: 'auto' });
        ...
        if (detailsIn) {
          restoreDetails?.();
          gsapWithCSS.set(detailsIn, { height: 0 });
        }

        // Animate wrapper height towards the measured target.
        if (targetH > 0) {
          gsapWithCSS.to(wrapper, { height: targetH, duration: 0.5, ease: 'power3.out' });
        }
        ...
        const tl = gsapWithCSS.timeline({
          ...
          onComplete: () => {
            ...
            gsapWithCSS.delayedCall(0, recomputeActiveHeight);
          },
        });
...
//# sourceMappingURL=tabs-BAi6vg0J.js.map
