	...
	const components = [
	  {
	    ...
	    importFn: () => import('./tooltip-BvM2Kz4Z.js'),
	  },
	  {
	    selector: "[data-component='events']",
	    importFn: () => import('./events-nfIfxa2S.js'),
	  },
	  {
	    selector: "[data-component='centers-coe']",
	    importFn: () => import('./centers-coe-BjQjV9r9.js'),
	  },
	  {
	    selector: "[data-component='centers-all']",
	    importFn: () => import('./centers-all-M3WBAa_L.js'),
	  },
	  {
	    selector: "[data-component='donation-form']",
	    importFn: () => import('./donation-bUYxjk7w.js'),
	  },
	  {
	    selector: "[data-component='join-us-form']",
	    importFn: () => import('./join-us-XOLvCviX.js'),
	  },
	  {
	    selector: "[data-component='helpline-form']",
	    importFn: () => import('./helpline-aQYZ0Z1H.js'),
	  },
	  {
	    selector: "[data-component='phone-buddy-form']",
	    importFn: () => import('./phone-buddy-Y1Myxb1r.js'),
	  },
	  {
	    selector: "[data-component='volunteer-phone-buddy-form']",
	    importFn: () => import('./volunteer-phone-buddy-DzES331M.js'),
	  },
	  {
	    selector: "[data-component='including-form']",
	    importFn: () => import('./including-DFiMfXBQ.js'),
	  },
	  {
	    selector: "[data-component='mind-over-matter-form']",
	    importFn: () => import('./mind-over-matter-BCdZAn90.js'),
	  },
	  {
	    selector: "[data-component='share-your-story-form']",
	    importFn: () => import('./share-your-story-CqastRv_.js'),
	  },
	  {
	    selector: "[data-component='support-group-interest']",
	    importFn: () => import('./support-group-interest-DX3J-CY3.js'),
	  },
	  {
	    selector: "[data-component='email-subscribe']",
	    importFn: () => import('./email-subscribe-U6-jk_vP.js'),
	  },
	  {
	    selector: "[data-component='graphics-bars']",
	    importFn: () => import('./graphics-bars-USQ9Vpea.js'),
	  },
	  {
	    selector: "[data-component='graphics-pies']",
	    importFn: () => import('./graphics-pies-CSkZKEZr.js'),
	  },
	  {
	    selector: "[data-component='state-graphics']",
	    importFn: () => import('./state-graphics-BZ76Le3e.js'),
	  },
	  {
	    selector: "[data-component='breadcrumbs']",
	    importFn: () => import('./breadcrumbs-V2xIRTt8.js'),
	  },
	  {
	  ...
	  },
	  {
	    ...
	    importFn: () => import('./tabs-DxueDbep.js'),
	  },
	  {
	  ...
	  },
	  {
	    ...
	    importFn: () => import('./testimonial-slider-DkWeWvfe.js'),
	  },
	  {
	  ...
	  },
	  {
	    ...
	    importFn: () => import('./social-share-BnL08HpF.js'),
	  },
...
//# sourceMappingURL=main-D4haU8ah.js.map
