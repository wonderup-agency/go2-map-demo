import { C as Container, m as mergeTags, R as RoundedRectangle, T as Theme, a as ColorSet, b as Color, s as setColor, p as p100, c as p50, i as isNumber, d as copy, e as copy$1, r as round, f as round$1, g as percent, S as SerialChart, L as ListAutoDispose, G as Graphics, h as Rectangle, j as remove, k as isLocalEvent, l as keys, n as each, o as each$1, q as move, t as compareNumber, P as Percent, u as Series, v as List, D as DataItem, w as removeFirst, x as capitalizeFirst, y as relativeToValue, _ as __awaiter, z as visualSettings, A as isNaN$1, B as Component, M as MultiDisposer, E as decimalPlaces, F as fitToRange, H as ceil, I as populateString, J as Label, K as Tick, N as ListTemplate, O as Template, Q as sameBounds, U as addLicense, V as ready, W as Root, X as AnimatedTheme, Y as color } from './AnimatedTheme-BTuTTi7R.js';
...
async function graphicsBars (component) {
  ...
  ready(function () {
    document.querySelectorAll('[data-graphic-type="bars"]').forEach((el) => {
      ...
      const BACKGROUND = color(isDark ? '#1B2155' : '#FFFFFF');
      const BAR_COLOR = color(isDark ? '#B9DDE6' : '#B9DDE6');
      const TEXT_COLOR = color(isDark ? '#FFFFFF' : '#1B2155');
      ...
      chart.plotContainer.set('background', Rectangle.new(root, { fill: color(0x000000), fillOpacity: 0 }));
...
//# sourceMappingURL=graphics-bars-DBXLfKm0.js.map
