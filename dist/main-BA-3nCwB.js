...
function requireMain () {
	...
	const components = [
	  ...
	  },
	  {
	    ...
	    importFn: () => import('./centers-coe-Bn9GFf4C.js'),
	  },
	  {
	    selector: "[data-component='centers-all']",
	    importFn: () => import('./centers-all-CC3cbbUn.js'),
	  },
	  {
	  ...
	  },
	  {
	    ...
	    importFn: () => import('./join-us-BhnD1fIK.js'),
	  },
	  {
	    selector: "[data-component='helpline-form']",
	    importFn: () => import('./helpline-DeVbgp5L.js'),
	  },
	  {
	    selector: "[data-component='phone-buddy-form']",
	    importFn: () => import('./phone-buddy-C37TuyLw.js'),
	  },
	  {
	    selector: "[data-component='volunteer-phone-buddy-form']",
	    importFn: () => import('./volunteer-phone-buddy-37HePD3N.js'),
	  },
	  {
	    selector: "[data-component='including-form']",
	    importFn: () => import('./including-DINLneQo.js'),
	  },
	  {
	    selector: "[data-component='mind-over-matter-form']",
	    importFn: () => import('./mind-over-matter-Fn6Y2W9I.js'),
	  },
	  {
	    selector: "[data-component='share-your-story-form']",
	    importFn: () => import('./share-your-story-CJT9ZN1V.js'),
	  },
	  {
	    selector: "[data-component='support-group-interest']",
	    importFn: () => import('./support-group-interest-BKFPc45w.js'),
	  },
	  {
	  ...
	  },
	  {
	    ...
	    importFn: () => import('./graphics-pies-Dhkgzgso.js'),
	  },
	  {
	  ...
	  },
	  {
	    ...
	    importFn: () => import('./breadcrumbs-BaV33D7U.js'),
	  },
	  {
...
//# sourceMappingURL=main-BA-3nCwB.js.map
