...
function requireMain () {
	...
	const components = [
	  ...
	  },
	  {
	    ...
	    importFn: () => import('./centers-yMLbMEtP.js'),
	  },
	  {
	  ...
	  },
	  {
	    ...
	    importFn: () => import('./join-us-W2558gmN.js'),
	  },
	  {
	    selector: "[data-component='helpline-form']",
	    importFn: () => import('./helpline-CcaFQdSV.js'),
	  },
	  {
	    selector: "[data-component='phone-buddy-form']",
	    importFn: () => import('./phone-buddy-CCtTpH3B.js'),
	  },
	  {
	    selector: "[data-component='volunteer-phone-buddy-form']",
	    importFn: () => import('./volunteer-phone-buddy-1Hb5Uw1U.js'),
	  },
	  {
	    selector: "[data-component='including-form']",
	    importFn: () => import('./including-BlRBYkMe.js'),
	  },
	  {
	    selector: "[data-component='mind-over-matter-form']",
	    importFn: () => import('./mind-over-matter-D2mN4BA-.js'),
	  },
	  {
	    selector: "[data-component='share-your-story-form']",
	    importFn: () => import('./share-your-story-BRYYX2cL.js'),
	  },
	  {
	    selector: "[data-component='support-group-interest']",
	    importFn: () => import('./support-group-interest-C1Jq4zfC.js'),
	  },
	  {
	  ...
	  },
	  {
	    ...
	    importFn: () => import('./tabs-DH1ptt-u.js'),
	  },
	  {
...
//# sourceMappingURL=main-CjIGNNe8.js.map
